...
class MarsSignalClient {
  constructor(options = {}) {
    ...
    // 生产环境：GitHub Actions 部署时会替换 wss://princess-conversations-profit-sharon.trycloudflare.com/ws 为实际后端地址
    const defaultUrl = (typeof window !== 'undefined' && window.location.hostname.includes('github.io'))
      ? 'wss://princess-conversations-profit-sharon.trycloudflare.com/ws'
